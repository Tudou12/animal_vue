        ...
        <el-form :label-position="labelPosition" label-width="80px" :model="ruleForm2" :rules="rules2">
          ...
          <div class="button" placeholder="请输入">
            <el-form-item style="width: 100%">
              <el-button type="primary" style="background: #505458;border: none" @click="resetForm('ruleForm2')">重置
              </el-button>
              <el-button type="primary" style="background: #505458;border: none" @click="submitForm('ruleForm2')">注册
              </el-button>
            </el-form-item>
          </div>
        </el-form>
